...
import com.test.app.JSONParserDemo;
import org.json.*;
...
public class JSONParserDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			String resourceName = "/generated.json";
			InputStream is = JSONParserDemo.class.getResourceAsStream(resourceName);
			if (is == null) {
...
//				 }
	...
	// Ispisati samo mail iz objekata al da mail nadje preko regexa.	 
